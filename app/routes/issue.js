...
module.exports.setRouter = (app)=>{
    ...
    app.post(`${baseUrl}/:issueId/edit`,authMiddleware.isAuthorized,upload.upload,issueController.editIssue);
    app.post(`${baseUrl}/:issueId/delete`,authMiddleware.isAuthorized,issueController.deleteAIssue);
    app.post(`${baseUrl}/deleteAll`,authMiddleware.isAuthorized,issueController.deleteAll);
